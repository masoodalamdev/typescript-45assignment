...
console.log("We can invite only two people for dinner")
 while (people.length > 2) {
    const removePerson = people.pop()
    console.log(`We're sorry, we can't invite ${removePerson}`)
 }
 console.log(`${people[0]}, you are still invited for dinner`)
 console.log(`${people[1]}, you are still invited for dinner`)
 while (people.length = 0) {
    const removePerson = people.pop()
    console.log(`removing ${removePerson}`)
 }
 console.log(people)